...
public class AsiaFlagQuizActivity extends Activity {
...
//                startActivity(intent);
    ...
    private void initializeData() {
        // 假设这里有一些国家名称和对应的国旗资源
        countries = new String[]{"Китай", "Япония", "Южная Корея","Пакистан","Монголия","Вьетнам","Сингапур"};
        flags = new int[]{R.drawable.quiz_china, R.drawable.quiz_japan, R.drawable.quiz_korea, R.drawable.quiz_pakistan, R.drawable.quiz_mongolia, R.drawable.quiz_vietnam, R.drawable.quiz_singapore};
        answers = countries;//new String[]{"中国", "日本", "韩国","巴基斯坦","蒙古","越南","新加坡"};
