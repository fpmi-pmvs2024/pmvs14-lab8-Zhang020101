...
public class OceaniaFlagQuizActivity extends Activity {
...
//                startActivity(intent);
    ...
    private void initializeData() {
        // 假设这里有一些国家名称和对应的国旗资源
        countries = new String[]{"Австралия", "Новая Зеландия", "Фиджи","Соломон","Науру","Тонга","Папуа-Новая Гвинея"};
        flags = new int[]{R.drawable.quiz_australia, R.drawable.quiz_new_zealand, R.drawable.quiz_fiji, R.drawable.quiz_solomon, R.drawable.quiz_nauru, R.drawable.quiz_tonga, R.drawable.quiz_papua_new_guinea};
        answers = countries;// new String[]{"澳大利亚", "新西兰", "斐济","所罗门","瑙鲁","汤加","巴布亚新几内亚"};
