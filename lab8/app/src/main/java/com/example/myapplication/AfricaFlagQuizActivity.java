...
public class AfricaFlagQuizActivity extends Activity {
...
//                startActivity(intent);
    ...
    private void initializeData() {
        // 假设这里有一些国家名称和对应的国旗资源
        countries = new String[]{"Египет", "Тунис", "Ливия","Марокко","Сомали","Джибути","Кения","Уганда"};
        flags = new int[]{R.drawable.quiz_egypt, R.drawable.quiz_tunisia, R.drawable.quiz_libya, R.drawable.quiz_morocoo, R.drawable.quiz_somalia, R.drawable.quiz_djibouti, R.drawable.quiz_konya, R.drawable.quiz_uganda};
        answers = countries;//new String[]{"埃及", "突尼斯", "利比亚","摩洛哥","索马里","吉布提","肯尼亚","乌干达"};
